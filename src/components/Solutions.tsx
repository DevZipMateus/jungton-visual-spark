...
const Solutions = () => {
  ...
  const solutions = [{
    ...
    services: ["Placas e sinalização técnica", "Totens e fachadas personalizadas", "Comunicação visual para stands e mostras", "Revestimentos e painéis decorativos"]
  }, {
    ...
    services: ["Fachadas e luminosos", "Comunicação interna e PDV", "Adesivos, banners e displays promocionais", "Totens e sinalização de setores"]
  }, {
    ...
    services: ["Fachadas e placas de identificação", "Sinalização interna (consultórios, recepções, salas)", "Adesivos decorativos e privativos", "Comunicação para campanhas e eventos"]
  }, {
    ...
    services: ["Fachadas e sinalização corporativa", "Totens e comunicação institucional", "Impressão digital de grande formato", "Adesivos e letras caixa"]
  }];
  ...
  return <section id="solutions" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <img src={textureGrid} alt="" className="w-full h-full object-cover opacity-20" />
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16 animate-fade-in">
            ...
            <div className="relative max-w-2xl mx-auto mb-6 md:mb-8 px-4">
              ...
              <h2 className="text-center text-base font-bold uppercase mb-8 md:text-3xl">
            ...
            <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen mb-8">
              <svg width="100%" height="16" preserveAspectRatio="none" viewBox="0 0 1000 16" className="w-full">
                {/* Left line */}
                <line x1="0" y1="2" x2="490" y2="2" stroke="hsl(var(--foreground))" strokeWidth="2.5" />
                {/* Downward V notch */}
                <polyline points="490,2 500,12 510,2" stroke="hsl(var(--foreground))" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" />
                {/* Right line */}
                <line x1="510" y1="2" x2="1000" y2="2" stroke="hsl(var(--foreground))" strokeWidth="2.5" />
              </svg>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4 md:px-0">
            ...
            animationDelay: `${index * 0.1}s`
                ...
                <div className="relative h-48 overflow-hidden">
                  <OptimizedImage src={solution.image} alt={solution.title} className="w-full h-full object-cover transition-smooth hover:scale-110" priority={index < 3} />
          ...
          <div className="relative w-full mt-8">
            <svg width="100%" height="16" preserveAspectRatio="none" viewBox="0 0 1000 16" className="w-full">
              ...
              <line x1="0" y1="12" x2="15" y2="12" stroke="hsl(var(--foreground))" strokeWidth="2.5" />
              {/* Upward V notch */}
              <polyline points="15,12 25,2 35,12" stroke="hsl(var(--foreground))" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" />
              {/* Line continuing to end */}
              <line x1="35" y1="12" x2="1000" y2="12" stroke="hsl(var(--foreground))" strokeWidth="2.5" />
            </svg>
          </div>
        </div>
      </div>
