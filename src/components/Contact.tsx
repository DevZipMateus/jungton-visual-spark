        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="h-96 lg:h-full min-h-[400px] rounded-lg overflow-hidden shadow-elegant animate-fade-in">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3456.7891234567!2d-53.8159!3d-29.6832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDQwJzU5LjUiUyA1M8KwNDgnNTcuMiJX!5e0!3m2!1spt-BR!2sbr!4v1234567890&q=Rua+Otávio+Silvestre+de+Oliveira,+120,+Santa+Maria,+RS"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Localização Jungton Comunicação Visual - R. Otávio Silvestre de Oliveira, 120"
              />
            </div>
